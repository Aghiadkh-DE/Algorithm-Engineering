#include "lodepng/lodepng.h" // this should be #include "lodepng.h"
#include <cstdio>
#include <cstdlib>
#include "quantize/libimagequant.h" // this should be #include "libimagequant.h"

// https://fossies.org/linux/pngquant/lib/example.c
