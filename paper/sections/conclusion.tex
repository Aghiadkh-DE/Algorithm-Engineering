...
In this paper, we presented a high-performance document image binarization pipeline that integrates multiple preprocessing techniques and binarization methods, all accelerated through OpenMP parallelization. The pipeline was implemented in a modular C++ architecture, allowing flexible composition of denoising, background estimation and removal, contrast stretching, and five different binarization algorithms: Otsu's method, Nick's method, Sauvola's method, the Su-Lu-Tan method, and a proposed adaptive method.
...
\begin{tabular}{|c|c|c|}
\hline
\textbf{Method} & \textbf{Without Preprocessing} & \textbf{With Preprocessing} \\
\hline
Original & \multicolumn{2}{c|}{\includegraphics[width=0.35\textwidth]{images/test.jpg}} \\
\hline
Otsu &
\includegraphics[width=0.35\textwidth]{images/otsu.png} &
\includegraphics[width=0.35\textwidth]{images/otsu_with_preprosseing.png} \\
\hline
Nick &
--- &
\includegraphics[width=0.35\textwidth]{images/nick_with_preprosseing.png} \\
\hline
Sauvola &
\includegraphics[width=0.35\textwidth]{images/sauvola.png} &
\includegraphics[width=0.35\textwidth]{images/sauvola_with_preprosseing.png} \\
\hline
Su &
\includegraphics[width=0.35\textwidth]{images/su.png} &
\includegraphics[width=0.35\textwidth]{images/su_with_preprosseing.png} \\
\hline
Proposed &
\includegraphics[width=0.35\textwidth]{images/proposed.png} &
\includegraphics[width=0.35\textwidth]{images/proposed_with_preprosseing.png} \\
\hline
\end{tabular}
\end{table*}
