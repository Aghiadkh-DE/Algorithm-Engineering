...
The adaptive thresholding method proposed by Bataineh et al. is implemented as a local thresholding algorithm
...
The method proposed by Su et al. (2010) is designed for the
